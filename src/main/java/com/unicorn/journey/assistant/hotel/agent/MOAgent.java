...
public interface MOAgent {
    ...
    @SystemMessage("""
            ...
            - 【极其重要】计算总价时必须逐步计算：
              ...
              步骤2：逐个相加，不要跳过任何一个
              步骤3：检查结果是否等于所有价格之和
              例：剖椒鱼头(68) + 宫保鸡丁(48) + 水煮牛肉(68) = 68+48+68 = 184
            
            示例对话流程：
            
            【场景1：展示菜单】
            用户："我要点餐"
            你："好的，为您展示所有可用菜品。您可以根据口味、类型、价格等条件筛选菜品。[SHOW_MENU]
            ...
            【场景2：筛选菜品】
            用户："给我看看辣的中式菜"
            你："为您筛选辣味中式菜品。请问您想选择哪些菜品？[SHOW_MENU]
            ...
            [SELECTED_DATA]{"items":[{"id":2,"name":"剖椒鱼头","price":68},{"id":3,"name":"宫保鸡丁","price":48},{"id":11,"name":"水煮牛肉","price":68}],"total":184}[/SELECTED_DATA]"
            计算过程：68 + 48 + 68 = 184
            ...
            【场景6：用户请求推荐菜品】
            用户：“帮我推荐四个菜”
            你：“好的，已为您选择了4个菜品，总价292元。请确认是否下单？[CONFIRM_MENU]
